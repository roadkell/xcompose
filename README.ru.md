...
Таблица [клавиатурных комбинаций](https://ru.wikipedia.org/wiki/Compose), позволяющая вводить буквы кириллических алфавитов и символы, недоступные в ЙЦУКЕН (~@#$^&[]{}|'`<>), из одной раскладки.
