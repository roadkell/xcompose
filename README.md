...
Таблица Compose-последовательностей (а в будущем и раскладка для AltGr-слоя), упрощающая ввод букв кириллических алфавитов без необходимости устанавливать несколько раскладок. Аналог US-International, только для кириллицы.
